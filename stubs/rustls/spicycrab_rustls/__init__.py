...
be obtained using the `take` function"""
    ...
    def read_buf(self, cursor: object) -> object: ...
...
This allows you to use a rustls Connection like a normal stream."""
    ...
    def read_buf(self, cursor: object) -> None: ...
...
__all__: list[str] = ["derive_traffic_key", "derive_traffic_iv", "fuzz_deframer", "default_cert_decompressors", "default_cert_compressors", "verify_server_cert_signed_by_trust_anchor", "verify_server_name", "verify_tls12_signature", "verify_tls13_signature", "verify_tls13_signature_with_raw_key", "default_fips_provider", "make_tls13_aad", "make_tls12_aad", "public_key_to_spki", "default_provider", "any_supported_type", "any_ecdsa_type", "any_eddsa_type", "default_provider", "any_supported_type", "any_ecdsa_type", "any_eddsa_type", "expand", "Tls13CipherSuite", "CommonState", "IoState", "TicketSwitcher", "TicketRotator", "AlertMessagePayload", "Tls13ClientSessionValue", "Tls12ClientSessionValue", "ClientSessionCommon", "ServerSessionValue", "ChangeCipherSpecPayload", "Reader", "u24", "MessageFragmenter", "PlainMessage", "Message", "OutboundPlainMessage", "OutboundOpaqueMessage", "PrefixedPayload", "InboundOpaqueMessage", "BorrowedPayload", "InboundPlainMessage", "PayloadU16", "MaybeEmpty", "NonEmpty", "FfdheGroup", "UnknownExtension", "HandshakeMessagePayload", "HpkeSymmetricCipherSuite", "HpkeKeyConfig", "EchConfigContents", "KeyLogFile", "SupportedProtocolVersion", "ClientConnection", "ServerConnection", "ConnectionCommon", "Secrets", "DirectionalKeys", "Tag", "PacketKeySet", "Suite", "Keys", "DecompressionFailed", "CompressionFailed", "CompressionCacheInner", "CipherSuiteCommon", "ExtractedSecrets", "GetRandomFailed", "HandshakeSignatureValid", "ServerCertVerified", "ClientCertVerified", "NoClientAuth", "DigitallySignedStruct", "UnbufferedStatus", "ReadTraffic", "ReadEarlyData", "AppDataRecord", "WriteTraffic", "EncodeTlsData", "TransmitTlsData", "InsufficientSizeError", "KernelConnection", "Tls12CipherSuite", "Stream", "StreamOwned", "RootCertStore", "ServerCertVerifierBuilder", "WebPkiServerVerifier", "WebPkiSupportedAlgorithms", "ParsedCertificate", "ClientCertVerifierBuilder", "WebPkiClientVerifier", "ConfigBuilder", "WantsVersions", "WantsVerifier", "DefaultTimeProvider", "NoKeyLog", "NoServerSessionStorage", "ServerSessionMemoryCache", "AlwaysResolvesServerRawPublicKeys", "ResolvesServerCertUsingSni", "ClientHello", "ServerConfig", "ReadEarlyData", "ServerConnection", "Acceptor", "AcceptedAlert", "UnbufferedServerConnection", "Accepted", "ServerConnectionData", "WantsServerCert", "ClientSessionMemoryCache", "AlwaysResolvesClientRawPublicKeys", "DangerousClientConfigBuilder", "WantsClientCert", "ClientConfig", "Resumption", "DangerousClientConfig", "WriteEarlyData", "ClientConnection", "UnbufferedClientConnection", "MayEncryptEarlyData", "ClientConnectionData", "EchConfig", "EchGreaseConfig", "OtherError", "Tag", "CryptoProvider", "CompletedKeyExchange", "SharedSecret", "UnsupportedOperationError", "KeyBlockShape", "Iv", "Nonce", "AeadKey", "HpkeSuite", "HpkePublicKey", "HpkePrivateKey", "HpkeKeyPair", "EncapsulatedSecret", "SingleCertAndKey", "CertifiedKey", "PrfUsingHmac", "Output", "Ticketer", "RsaSigningKey", "Ticketer", "HpkeAwsLcRs", "RsaSigningKey", "HkdfExpanderUsingHmac", "HkdfUsingHmac", "OkmBlock", "OutputLengthError", "Mutex", "Mutex", "Poisoned", "Reader", "Writer", "ConnectionCommon", "UnbufferedConnectionCommon", "HandshakeKind", "Side", "MessagePayload", "MessageError", "OutboundChunks", "Payload", "KeyExchangeAlgorithm", "EchConfigPayload", "EchConfigExtension", "Connection", "KeyChange", "Version", "CompressionLevel", "CompressionCache", "SupportedCipherSuite", "ConnectionTrafficSecrets", "ConnectionState", "EncodeError", "EncryptError", "VerifierBuilderError", "Tls12Resumption", "EarlyDataError", "EchMode", "EchStatus", "Error", "InconsistentKeys", "InvalidMessage", "PeerMisbehaved", "PeerIncompatible", "CertificateError", "ExtendedKeyPurpose", "CertRevocationListError", "EncryptedClientHelloError", "Connection"]
