...
def compress(state: object, blocks: object) -> None: ...

def compress(state: object, blocks: object) -> None: ...

"""Performs 2 rounds of the SHA-512 message schedule update."""
def sha512_schedule_x2(v0: object, v1: object, v4to5: object, v7: object) -> object: ...

"""Performs one round of the SHA-512 message block digest."""
def sha512_digest_round(ae: object, bf: object, cg: object, dh: object, wk0: int) -> object: ...

"""Process a block with the SHA-512 algorithm."""
def sha512_digest_block_u64(state: object, block: object) -> None: ...
...
__all__: list[str] = ["compress", "compress", "sha512_schedule_x2", "sha512_digest_round", "sha512_digest_block_u64", "compress", "compress", "compress", "compress", "compress", "compress", "compress", "compress", "compress256", "compress512", "Sha256VarCore", "Sha512VarCore"]
