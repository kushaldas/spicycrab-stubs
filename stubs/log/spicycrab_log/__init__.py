...
class Key:
    ...
    @staticmethod
    def from_str_static(key: object) -> "Key": ...

    def as_str(self) -> str: ...

    def to_borrowed_str(self) -> object: ...

    def to_static_str(self) -> object: ...
...
__all__: list[str] = ["visit", "visit", "log", "enabled", "loc", "capture_to_value", "capture_debug", "capture_display", "capture_error", "capture_sval", "capture_serde", "set_max_level", "set_max_level_racy", "max_level", "set_boxed_logger", "set_logger", "set_logger_racy", "logger", "Key", "Value", "Error", "GlobalLogger", "Record", "RecordBuilder", "Metadata", "MetadataBuilder", "SetLoggerError", "ParseLevelError", "Inner", "Token", "Level", "LevelFilter"]
