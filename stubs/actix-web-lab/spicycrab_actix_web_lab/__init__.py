...
[HTTP Strict Transport Security (HSTS)]: https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Strict-Transport-Security"""
    ...
    def allow_hosts(self, hosts: I) -> Self: ...
...
__all__: list[str] = ["echo_path_service", "new_infallible_body_stream", "new_infallible_sized_stream", "spa", "writer", "map_response", "map_response_body", "channel", "fork_request_payload", "StrictTransportSecurity", "ClearSiteData", "LocalData", "UrlEncodedForm", "UrlEncodedFormExtractFut", "UrlEncodedFormDeserializeError", "SwapData", "MessagePack", "MessagePackNamed", "Query", "QueryDeserializeError", "Path", "RedirectHttps", "RedirectHttpsMiddleware", "Writer", "CacheControl", "Data", "LazyDataShared", "NormalizePath", "NormalizePathService", "RedirectToWww", "RedirectToWwwMiddleware", "Bytes", "BytesExtractFut", "CatchPanic", "CatchPanicMiddleware", "Spa", "LoadShed", "LoadShedService", "Json", "JsonExtractFut", "JsonDeserializeError", "PanicReporter", "PanicReporterMiddleware", "BodyLimit", "BodyLimitFut", "Host", "LazyData", "MapResMiddleware", "MapResService", "XForwardedPrefix", "ReconstructedPath", "ErrorHandlers", "ErrorHandlersMiddleware", "Cbor", "MapResBodyMiddleware", "MapResBodyService", "RedirectToNonWww", "RedirectToNonWwwMiddleware", "ContentLength", "RequestSignature", "Sender", "HostAllowlist", "ConditionOption", "Forwarded", "ClearSiteDataDirective", "UrlEncodedFormBody", "UrlEncodedFormError", "CacheDirective", "Event", "BytesBody", "BytesPayloadError", "Overloaded", "JsonBody", "JsonPayloadError", "BodyLimitError", "RequestSignatureError", "ConditionMiddleware"]
