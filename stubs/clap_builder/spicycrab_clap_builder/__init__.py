...
[`Command::get_matches`]: crate::Command::get_matches()"""
    ...
    def get_one(self, id: str) -> str | None: ...

    def get_count(self, id: str) -> int: ...

    def get_flag(self, id: str) -> bool: ...

    def get_many(self, id: str) -> list[str]: ...
...
__all__: list[str] = ["ArgAction", "ValueHint", "Id", "AnyValueId", "KindFormatter", "RichFormatter", "Error", "ArgMatches", "IdsRef", "Values", "ValuesRef", "RawValues", "Occurrences", "OccurrenceValues", "OccurrencesRef", "OccurrenceValuesRef", "RawOccurrences", "RawOccurrenceValues", "Indices", "ValueRange", "PossibleValue", "ValueParser", "StringValueParser", "OsStringValueParser", "PathBufValueParser", "EnumValueParser", "PossibleValuesParser", "RangedI64ValueParser", "RangedU64ValueParser", "BoolValueParser", "FalseyValueParser", "BoolishValueParser", "NonEmptyStringValueParser", "MapValueParser", "TryMapValueParser", "UnknownArgumentValueParser", "_infer_ValueParser_for", "_AnonymousValueParser", "OsStr", "Command", "Styles", "ArgGroup", "Arg", "Str", "StyledStr", "ReadmeDoctests", "ColorChoice", "ErrorKind", "ContextKind", "ContextValue", "ValueSource", "MatchesError", "ArgPredicate", "ValueHint", "Resettable", "ArgAction"]
