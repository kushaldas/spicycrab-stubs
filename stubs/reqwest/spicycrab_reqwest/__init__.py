...
class Response:
    ...
    async def text_with_charset(self, default_encoding: str) -> str: ...

    async def json(self) -> T: ...

    async def bytes(self) -> Bytes: ...

    async def chunk(self) -> Bytes | None: ...
    ...
    async def upgrade(self) -> Upgraded: ...
...
class ClientBuilder:
    ...
    def tls_sslkeylogfile(self, on: bool) -> ClientBuilder: ...
...
__all__: list[str] = ["get", "get", "basic_auth", "for_host", "never", "Result", "Policy", "Attempt", "Action", "Unnameable", "Internal", "Internal", "GaiResolver", "Name", "InvalidNameError", "Proxy", "NoProxy", "CertificateRevocationList", "Certificate", "Identity", "Version", "TlsInfo", "Error", "Cookie", "Jar", "CookieService", "Response", "Client", "ClientBuilder", "Body", "Request", "RequestBuilder", "Form", "Part", "Response", "Client", "ClientBuilder", "Body", "Request", "RequestBuilder", "Form", "Part", "Response", "Client", "ClientBuilder", "Body", "Pool", "ConnectingLock", "ConnectingWaiter", "PoolClient", "PoolConnection", "Request", "RequestBuilder", "Upgraded", "Form", "Part", "Builder", "ScopeFn", "ClassifyFn", "ReqRep", "Connecting", "Action"]
