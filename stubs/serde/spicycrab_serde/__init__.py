...
class FlatMapSerializer:
    ...
    def serialize_unit_variant(self, _: object, _: int, variant: object) -> Ok: ...

    def serialize_newtype_struct(self, _: object, value: T) -> Ok: ...

    def serialize_newtype_variant(self, _: object, _: int, variant: object, value: T) -> Ok: ...

    def serialize_seq(self, _: int | None) -> SerializeSeq: ...

    def serialize_tuple(self, _: int) -> SerializeTuple: ...

    def serialize_tuple_struct(self, _: object, _: int) -> SerializeTupleStruct: ...

    def serialize_tuple_variant(self, _: object, _: int, variant: object, _: int) -> SerializeTupleVariant: ...

    def serialize_map(self, _: int | None) -> SerializeMap: ...

    def serialize_struct(self, _: object, _: int) -> SerializeStruct: ...

    def serialize_struct_variant(self, _: object, _: int, inner_variant: object, _: int) -> SerializeStructVariant: ...
